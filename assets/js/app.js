...
const currentLocation = document.querySelector("[data-current-location-btn]");
...
export const updateWeather = function (lat, lon) {
    ...
    if(window.location.hash == "#/current-location"){
        currentLocation.setAttribute("disabled", true);
    }else{
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
                ...
                <li class="meta-item">
                    ...
                    <p class="title-4 meta-text">${module.getDate(dateUnix, timezone)}</p>
                </li>
                <li class="meta-item">
                    <span class="m-icon">location_on</span>

                    <p class="title-4 meta-text" data-location></p>
                </li>
                </ul>`;
        ...
        fetchData(url.airPollution(lat, lon), function(airPollution){
            ...
            card.innerHTML=`
            <h2 class="title-2" id="highlight-label">Todays Highlights</h2>
            <div class="highlight-list">
              ...
              <div class="card card-sm highlight-card two">
                <h3 class="title-3">Sunset & Sunrise</h3>
                <div class="card-list">
                  <div class="card-item">
              ...
              <div class="card card-sm highlight-card">
                ...
                <div class="wrapper">
                  ...
                  <p class="title-1">${parseInt(feelsLike)}&deg;<sup>c</sup></p>
                </div>
              </div>
            </div>
            `;
        ...
        fetchData(url.forecast(lat, lon), function(forecast){
            ...
            for(const [index, data] of forecastList.entries()){
              ...
              windLi.innerHTML = `
                ...
                <p class="body-3">${module.mps_to_kmph(windSpeed)}km/h</p>
                </div>`;
